...
namespace Pixed.Application.Controls
{
    ...
    public class ExtendedNumeric : TemplatedControl
    {
        ...
        public static readonly StyledProperty<bool> AllowSpinProperty =
            ButtonSpinner.AllowSpinProperty.AddOwner<ExtendedNumeric>();
        ...
        public static readonly StyledProperty<Location> ButtonSpinnerLocationProperty =
            ButtonSpinner.ButtonSpinnerLocationProperty.AddOwner<ExtendedNumeric>();

        /// <summary>
        /// Defines the <see cref="ShowButtonSpinner"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> ShowButtonSpinnerProperty =
            ButtonSpinner.ShowButtonSpinnerProperty.AddOwner<ExtendedNumeric>();

        /// <summary>
        /// Defines the <see cref="ClipValueToMinMax"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> ClipValueToMinMaxProperty =
            AvaloniaProperty.Register<ExtendedNumeric, bool>(nameof(ClipValueToMinMax));

        /// <summary>
        /// Defines the <see cref="NumberFormat"/> property.
        /// </summary>
        public static readonly StyledProperty<NumberFormatInfo?> NumberFormatProperty =
            AvaloniaProperty.Register<ExtendedNumeric, NumberFormatInfo?>(nameof(NumberFormat), NumberFormatInfo.CurrentInfo);

        /// <summary>
        /// Defines the <see cref="FormatString"/> property.
        /// </summary>
        public static readonly StyledProperty<string> FormatStringProperty =
            AvaloniaProperty.Register<ExtendedNumeric, string>(nameof(FormatString), string.Empty);

        /// <summary>
        /// Defines the <see cref="Increment"/> property.
        /// </summary>
        public static readonly StyledProperty<decimal> IncrementProperty =
            AvaloniaProperty.Register<ExtendedNumeric, decimal>(nameof(Increment), 1.0m, coerce: OnCoerceIncrement);

        /// <summary>
        /// Defines the <see cref="IsReadOnly"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> IsReadOnlyProperty =
            AvaloniaProperty.Register<ExtendedNumeric, bool>(nameof(IsReadOnly));

        /// <summary>
        /// Defines the <see cref="Maximum"/> property.
        /// </summary>
        public static readonly StyledProperty<decimal> MaximumProperty =
            AvaloniaProperty.Register<ExtendedNumeric, decimal>(nameof(Maximum), decimal.MaxValue, coerce: OnCoerceMaximum);

        /// <summary>
        /// Defines the <see cref="Minimum"/> property.
        /// </summary>
        public static readonly StyledProperty<decimal> MinimumProperty =
            AvaloniaProperty.Register<ExtendedNumeric, decimal>(nameof(Minimum), decimal.MinValue, coerce: OnCoerceMinimum);
        ...
        public static readonly StyledProperty<NumberStyles> ParsingNumberStyleProperty =
            AvaloniaProperty.Register<ExtendedNumeric, NumberStyles>(nameof(ParsingNumberStyle), NumberStyles.Any);

        /// <summary>
        /// Defines the <see cref="Text"/> property.
        /// </summary>
        public static readonly StyledProperty<string?> TextProperty =
            AvaloniaProperty.Register<ExtendedNumeric, string?>(nameof(Text),
        ...
        public static readonly StyledProperty<IValueConverter?> TextConverterProperty =
            AvaloniaProperty.Register<ExtendedNumeric, IValueConverter?>(nameof(TextConverter), defaultBindingMode: BindingMode.OneWay);

        /// <summary>
        /// Defines the <see cref="Value"/> property.
        /// </summary>
        public static readonly StyledProperty<decimal?> ValueProperty =
            AvaloniaProperty.Register<ExtendedNumeric, decimal?>(nameof(Value), coerce: (s, v) => ((ExtendedNumeric)s).OnCoerceValue(v),
                defaultBindingMode: BindingMode.TwoWay, enableDataValidation: true);
        ...
        public static readonly StyledProperty<string?> WatermarkProperty =
            AvaloniaProperty.Register<ExtendedNumeric, string?>(nameof(Watermark));

        /// <summary>
        /// Defines the <see cref="HorizontalContentAlignment"/> property.
        /// </summary>
        public static readonly StyledProperty<HorizontalAlignment> HorizontalContentAlignmentProperty =
            ContentControl.HorizontalContentAlignmentProperty.AddOwner<ExtendedNumeric>();

        /// <summary>
        /// Defines the <see cref="VerticalContentAlignment"/> property.
        /// </summary>
        public static readonly StyledProperty<VerticalAlignment> VerticalContentAlignmentProperty =
            ContentControl.VerticalContentAlignmentProperty.AddOwner<ExtendedNumeric>();

        /// <summary>
        /// Defines the <see cref="TextAlignment"/> property
        /// </summary>
        public static readonly StyledProperty<Avalonia.Media.TextAlignment> TextAlignmentProperty =
            TextBox.TextAlignmentProperty.AddOwner<ExtendedNumeric>();

        /// <summary>
        /// Defines the <see cref="InnerLeftContent"/> property
        /// </summary>
        public static readonly StyledProperty<object?> InnerLeftContentProperty =
            TextBox.InnerLeftContentProperty.AddOwner<ExtendedNumeric>();

        /// <summary>
        /// Defines the <see cref="InnerRightContent"/> property
        /// </summary>
        public static readonly StyledProperty<object?> InnerRightContentProperty =
            TextBox.InnerRightContentProperty.AddOwner<ExtendedNumeric>();
        ...
        /// <summary>
        /// Gets or sets the <see cref="Media.TextAlignment"/> of the <see cref="ExtendedNumeric"/>
        /// </summary>
        public Avalonia.Media.TextAlignment TextAlignment
        {
        ...
        /// <summary>
        /// Initializes new instance of <see cref="ExtendedNumeric"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes static members of the <see cref="ExtendedNumeric"/> class.
        /// </summary>
        static ExtendedNumeric()
        {
            ...
            FocusableProperty.OverrideDefaultValue<ExtendedNumeric>(true);
            IsTabStopProperty.OverrideDefaultValue<ExtendedNumeric>(false);
            KeyboardNavigation.TabNavigationProperty.OverrideDefaultValue<ExtendedNumeric>(KeyboardNavigationMode.Local);
        }
        ...
        {
            if (e.Sender is ExtendedNumeric upDown)
            {
        ...
        {
            if (instance is ExtendedNumeric upDown)
            {
        ...
        public static readonly RoutedEvent<ValueChangedEventArgs> ValueChangedEvent =
            RoutedEvent.Register<ExtendedNumeric, ValueChangedEventArgs>(nameof(ValueChanged), RoutingStrategies.Bubble);
