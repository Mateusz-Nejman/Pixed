...
internal abstract class DropHandlerBase : IDropHandler
{
    /// <summary>
    /// 
    /// </summary>
    ...
    protected static void MoveItem<T>(IList<T> items, int sourceIndex, int targetIndex)
    {
    ...
    /// <param name="targetIndex"></param>
    /// <typeparam name="T"></typeparam>
    protected static void MoveItem<T>(IList<T> sourceItems, IList<T> targetItems, int sourceIndex, int targetIndex)
    {
    ...
    /// <param name="targetIndex"></param>
    /// <typeparam name="T"></typeparam>
    protected static void SwapItem<T>(IList<T> items, int sourceIndex, int targetIndex)
    {
    ...
    /// <param name="targetIndex"></param>
    /// <typeparam name="T"></typeparam>
    protected static void SwapItem<T>(IList<T> sourceItems, IList<T> targetItems, int sourceIndex, int targetIndex)
    {
    ...
    /// <typeparam name="T"></typeparam>
    protected static void InsertItem<T>(IList<T> items, T item, int index)
    {
