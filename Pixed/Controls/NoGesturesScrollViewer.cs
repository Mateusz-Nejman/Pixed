...
public class NoGesturesScrollViewer : ScrollViewer, IScrollable, IScrollAnchorProvider, IInternalScroller
{
    /// <summary>
    ...
    public static readonly AttachedProperty<bool> BringIntoViewOnFocusChangeProperty =
        AvaloniaProperty.RegisterAttached<NoGesturesScrollViewer, Control, bool>(nameof(BringIntoViewOnFocusChange), true);

    /// <summary>
    /// Defines the <see cref="Extent"/> property.
    /// </summary>
    public static readonly DirectProperty<NoGesturesScrollViewer, Size> ExtentProperty =
        AvaloniaProperty.RegisterDirect<NoGesturesScrollViewer, Size>(nameof(Extent),
            o => o.Extent);
    ...
    public static readonly StyledProperty<Vector> OffsetProperty =
        AvaloniaProperty.Register<NoGesturesScrollViewer, Vector>(nameof(Offset), coerce: CoerceOffset);

    /// <summary>
    /// Defines the <see cref="Viewport"/> property.
    /// </summary>
    public static readonly DirectProperty<NoGesturesScrollViewer, Size> ViewportProperty =
        AvaloniaProperty.RegisterDirect<NoGesturesScrollViewer, Size>(nameof(Viewport),
            o => o.Viewport);

    /// <summary>
    /// Defines the <see cref="LargeChange"/> property.
    /// </summary>
    public static readonly DirectProperty<NoGesturesScrollViewer, Size> LargeChangeProperty =
        AvaloniaProperty.RegisterDirect<NoGesturesScrollViewer, Size>(
            nameof(LargeChange),
            o => o.LargeChange);
    ...
    /// </summary>
    public static readonly DirectProperty<NoGesturesScrollViewer, Size> SmallChangeProperty =
        AvaloniaProperty.RegisterDirect<NoGesturesScrollViewer, Size>(
            nameof(SmallChange),
            o => o.SmallChange);
    ...
    /// </summary>
    public static readonly DirectProperty<NoGesturesScrollViewer, Vector> ScrollBarMaximumProperty =
        AvaloniaProperty.RegisterDirect<NoGesturesScrollViewer, Vector>(
    ...
    public static readonly AttachedProperty<ScrollBarVisibility> HorizontalScrollBarVisibilityProperty =
        AvaloniaProperty.RegisterAttached<NoGesturesScrollViewer, Control, ScrollBarVisibility>(
    ...
    public static readonly AttachedProperty<SnapPointsType> HorizontalSnapPointsTypeProperty =
        AvaloniaProperty.RegisterAttached<NoGesturesScrollViewer, Control, SnapPointsType>(
    ...
    public static readonly AttachedProperty<SnapPointsAlignment> HorizontalSnapPointsAlignmentProperty =
        AvaloniaProperty.RegisterAttached<NoGesturesScrollViewer, Control, SnapPointsAlignment>(
    ...
    /// </summary>
    public static readonly DirectProperty<NoGesturesScrollViewer, bool> IsExpandedProperty =
        ScrollBar.IsExpandedProperty.AddOwner<NoGesturesScrollViewer>(o => o.IsExpanded);

    /// <summary>
    /// Defines the <see cref="AllowAutoHide"/> property.
    /// </summary>
    public static readonly AttachedProperty<bool> AllowAutoHideProperty =
        AvaloniaProperty.RegisterAttached<NoGesturesScrollViewer, Control, bool>(
    ...
    public static readonly RoutedEvent<ScrollChangedEventArgs> ScrollChangedEvent =
        RoutedEvent.Register<NoGesturesScrollViewer, ScrollChangedEventArgs>(
