...
RegexPair[] pairs = [
    ...
    new RegexPair("/Pixed.Android/Properties/AndroidManifest.debug.xml", "android:versionName=\"(.+?)\""),
    new RegexPair("/Pixed.Android/Properties/AndroidManifest.debug.xml", "android:versionCode=\"(.+?)\""),
